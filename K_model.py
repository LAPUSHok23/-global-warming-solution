...
def detect_class(image_path, model_path, labels_path):
    ...
    return class_name[2:len(class_name)-1].encode('1251').decode('utf-8'), confidence_score

def detect_object(image_path):
    base_class, base_class_score = detect_class(image_path, 'K_M\Model 7\keras_model7.h5', 'K_M\Model 7\labels7.txt')
